...
import com.dew.aihuaii.ui.adapter.GeneralListAdapter
import com.dew.aihuaii.ui.helper.AnimationUtils

/**
 *  Created by Edward on 3/22/2019.
 */
abstract class GeneralListFragment<I, N, A: GeneralListAdapter>: BaseStateFragment<I>(),
    ...
    override fun initViews(rootView: View, savedInstanceState: Bundle?) {
        ...
        listAdapter?.let {
            ...
            it.setFooter(getListFooter())
            it.setHeader(getListHeader())
        }
