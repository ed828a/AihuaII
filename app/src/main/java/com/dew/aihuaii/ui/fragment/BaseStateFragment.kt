...
import com.dew.aihuaii.ui.activity.MainActivity
import com.dew.aihuaii.ui.activity.ReCaptchaActivity
import com.dew.aihuaii.ui.helper.AnimationUtils.animateView
import com.dew.aihuaii.ui.helper.ErrorUtil
 ...
 */
abstract class BaseStateFragment<I> : BaseFragment(){
    ...
    ///////////////////////////////////////////////////////////////////////////
    // contract processing functions for state changes
    ///////////////////////////////////////////////////////////////////////////
    ...
    protected open fun showError(message: String, showRetryButton: Boolean) {
        Log.d(TAG, "showError() called with: message = [$message], showRetryButton = [$showRetryButton]")
        isLoading.set(false)

        // Todo 1: this action should be done by ViewModel
        // leave this action to the concrete fragment to pass Error event to ViewModel by calling a ViewModel method.
        // Todo: Seperating:      InfoCache.clearCache()
    ...
    protected open fun handleResult(result: I) {
        Log.d(TAG, "handleResult() called with: result = [$result]")
        hideLoading()

        // todo 2: Seperating : ViewModel should handle the result
    }
    ...
    protected open fun onError(exception: Throwable): Boolean {
        ...
        if (ErrorUtil.isInterruptedCaused(exception)) {
