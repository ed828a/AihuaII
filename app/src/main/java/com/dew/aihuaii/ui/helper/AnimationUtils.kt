...
import com.dew.aihuaii.BuildConfig.DEBUG
...
object AnimationUtils {
     ...
     */
    fun animateView(view: View, enterOrExit: Boolean, duration: Long, delay: Long = 0, execOnEnd: Runnable? = null, animationType: Type = AnimationUtils.Type.ALPHA) {
        if (DEBUG) {
            val id: String = try {
